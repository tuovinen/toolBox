...
*This Github repository contains few selected scripts and programs I use to help my daily work as a service supervisor. All code is written by me.*

| Program  | Language(s) | Description |
|---|---|---|
| ExcelSheetSeparator  | VBA | VBA script to separate sheets from an Excel workbook to their own files. |
| IP_address_heroku  | Python | A tool to test HTTP(S) requests and/or get an IP address of the source host. |
