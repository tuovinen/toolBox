...
| outlook_oldestitems.vba | VBA | This script is used to manage old and archived emails to follow the guidelines of GDPR regulation. The script iterates through multiple email folders and finds the oldets email per folder. |